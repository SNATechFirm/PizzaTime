...
const position = [21.1702 , 72.8311];
    ...
    return (
      <article className="section-2">
        ...
        <section className="section-2-info flex-container flex-column txt-center pop-font">
          ...
          <p>
          We Have variety Of Pizza For Give You Extream Plauser Of Test.    Just Call us And Give Us Chance To Make You Happy.
          </p>
        </section>
      </article>
    );
  ...
  render() {
    ...
    return (
      <article className="section-4 flex-container flex-column">
        ...
        Perfect Meal When You Are Hungry..
          </p>
        </section>
        {/* Meals Grid */}
